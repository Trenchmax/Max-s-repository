        ...
        ?>
            ...
            ?>
                <tr>
                    ...
                    <!-- http://localhost/ten_thu_muc/detail.php?id=$donhang['id_chitietdonhang'] -->
                    ...
                    <td><a href="chitietdonhang-detail.php?id=<?= $chitietdonhang['id_chitietdonhang'] ?>" target="_blank"><?= number_format($chitietdonhang['giaban']) ?></a>
