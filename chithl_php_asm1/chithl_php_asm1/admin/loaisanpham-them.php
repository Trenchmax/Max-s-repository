...
<div class="page-wrapper">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <form class="form-horizontal" action="add-loaisanpham-action.php" method="POST">
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text"  class="form-control" id="ten" placeholder="Nhập tên loại sản phẩm..." name="name">
                                </div>
                            </div>
                            <div class="form-group row">
